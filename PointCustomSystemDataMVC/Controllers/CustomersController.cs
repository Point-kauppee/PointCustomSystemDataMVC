...
namespace PointCustomSystemDataMVC.Controllers
{
    public class CustomersController : Controller
    {
        ...
        {
            var customer = db.Customer.Include(c => c.Personnel).Include(c => c.Phone).Include(c => c.PostOffices).Include(c => c.Reservation).Include(c => c.Treatment).Include(c => c.TreatmentOffice).Include(c => c.TreatmentPlace).Include(c => c.User).Include(c => c.Studentx);
